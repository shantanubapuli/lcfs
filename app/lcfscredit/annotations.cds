using CreditService as service from '../../srv/lcfs-service';

annotate service.Credit with @(
    UI.LineItem : [
        {
            $Type : 'UI.DataField',
            Label : 'Ren. Obj. No.',
...
annotate service.Credit with @(
    UI.FieldGroup #GeneratedGroup1 : {
        ...
        Data : [
            ...
            {
                $Type : 'UI.DataField',
                Label : 'Renewables Object Status Dsc',
                Value : status_dsc,
            },
            {
                $Type : 'UI.DataField',
            ...
            {
                $Type : 'UI.DataField',
                Label : 'Business Partner Number Dsc',
                Value : bp_no_dsc,
            },
            {
                $Type : 'UI.DataField',
